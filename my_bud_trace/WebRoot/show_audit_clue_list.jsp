...
<title>审核员列表</title>
	...
	<script type="text/javascript">
	    let onEdit=function(veid){
	    	...
	    	currForm.action="show_audit_clue.htm?clid="+veid;
	    	currForm.submit();
	    }
   </script>
                ...
                <div class="col-lg-12">
                    <div class="section-tittle mb-30 d-flex align-items-center justify-content-between" align="center">
                        <h2  style="background-color:LightSkyBlue;border-radius: 10px;
								border:3px solid grey;color:white;width:50%">待审核线索</h2>
                    </div>
                </div>
            </div>
                       ...
                       <c:choose>
      					<c:when test="${rows!=null }">   <!-- if -->
       		 			 ...
       		 			 <div class="whats-right-single mb-40">
	                            ...
	                            <a href="post_details.html"><img src="assets/img/gallery/whats_right_img2.jpg" alt=""></a>
	                        </div>
                        	<div class="whats-right-cap">
	                            <span>序号:${vs.count}</span>
	                            <h4><a href="#" onclick="onEdit('${ins.clid}')"><img src="img/edit.png"/>${ins.cldigest }</a></h4>
	                            <p>发布时间:</p>
			      				<p><a href="#" onclick="onEdit('${ins.clid}')">${ins.cltimecreate }</a><p>
			      				<p>发布人:</p>
	                            <p><a href="#" onclick="onEdit('${ins.clid}')" style="color:black;">${ins.uname }</a></p>
	                            <p>发现时间:</p>
	                            <p><a href="#" onclick="onEdit('${ins.clid}')" style="color:black;">${ins.cltimehap }</a></p>
                       		 </div>
                       	 </div>
                        </c:forEach>
                       			 <script>
