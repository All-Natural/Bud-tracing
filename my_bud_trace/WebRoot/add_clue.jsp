...
<%String postid=request.getParameter("clpostid"); %>
<%
	String Logtxt="";
	String toPath="";
...
<title>花蕾寻迹 & 基于儿童行为轨迹的状态分析及预警系统| 提供线索</title>
	<meta charset="UTF-8">
                ...
                <div class="col-lg-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item"><a href="show_post.htm?path=0&postid=<%= postid%>">找寻通知详情</a></li> 
                            <li class="breadcrumb-item"><a href="#">提供线索</a></li> 
                        </ol>
                    </nav>
                </div>
            </div>
							...
							<div class="register-form text-center">
								...
								<c:choose>
									<c:when test="${flag==1 }">
										<div>
											<p align="center">
											 	 <iframe src="upload.jsp?clid=${key }&type=1" width="400px" height="245px"
