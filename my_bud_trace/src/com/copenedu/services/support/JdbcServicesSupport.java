 ...
 *   就是在性能和通用之间寻找平衡
 */
package com.copenedu.services.support;
...
public abstract class JdbcServicesSupport
{
	...
	public final String getPageController(String url)
	{
		StringBuilder con=new StringBuilder()
				.append("<div class='seloption' style='float: left;'><select  name=\"query\"  id=\"pageController\" >")
				;
	 ...
	 * @throws Exception
	 */
	protected final Integer executeUpdateOfKey(String sql,Object...params)throws Exception
	{
		PreparedStatement pstm=null;
		try
		{
			pstm=DBUtils.prepareStatementOfKey(sql);
			int index=1;
			for(Object e:params)
			{
				pstm.setObject(index++,e);
